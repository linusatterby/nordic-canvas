...
import { useAdminHealth, logAdminAudit, type HealthCheck } from "@/hooks/useAdminHealth";
            ...
            <CardContent className="pt-4">
              <div className="flex gap-3">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <p>
                    Denna sida verifierar att databasen, RLS-policies och RPC-funktioner 
                    fungerar korrekt. Alla checks är read-only och påverkar ingen data.
                  </p>
                </div>
              </div>
            </CardContent>
