...
export const LABELS = {
  ...
  commsGroupsSubtitle: "Organisera personalen i grupper för riktade meddelanden.",
  commsCreateGroup: "Skapa grupp",
  commsGroupNamePlaceholder: "T.ex. Restaurangen",
  commsGroupName: "Gruppnamn",
  commsGroupMembers: "Medlemmar",
  commsAddMember: "Lägg till medlem",
  commsRemoveMember: "Ta bort",
  commsNoGroupsYet: "Inga grupper skapade ännu.",
  commsNoMembersYet: "Inga medlemmar i denna grupp.",
  commsCreateGroupFirst: "Skapa en grupp först.",
  commsManageMembers: "Hantera medlemmar",
  commsSaveGroup: "Spara",
  ...
  /* ── Onboarding ─────────────────────────────────── */
  onboardingTitle: "Introduktion",
  onboardingSubtitle: "Skapa och hantera introduktionsinnehåll för personalen.",
  onboardingNewItem: "Lägg till innehåll",
  onboardingEmpty: "Inget introduktionsinnehåll ännu",
  onboardingEmptyHint: "Skapa innehåll som hjälper nya medarbetare att komma igång.",
  onboardingTargetAll: "Alla anställda",
  onboardingTargetGroups: "Grupper",
  onboardingMarkComplete: "Markera som klar",
  onboardingCompleted: "Klar",
  onboardingNotStarted: "Ej påbörjad",
  onboardingNoOrg: "Skapa en organisation för att använda introduktion.",
  onboardingNoOrgTalent: "Du behöver vara kopplad till en organisation för att se introduktionsinnehåll.",
  onboardingStaffTitle: "Introduktion",
  onboardingStaffSubtitle: "Innehåll för att komma igång i din roll.",
  onboardingStaffEmpty: "Inget introduktionsinnehåll att visa.",
  onboardingTypeDocument: "Dokument",
  onboardingTypeVideo: "Video",
  onboardingTypeLink: "Länk",
  onboardingTypeChecklist: "Checklista",
  onboardingNoGroups: "Det finns inga grupper än.",
  onboardingNoGroupsHint: "Skapa grupper under Kommunikation för att kunna rikta innehåll.",
  onboardingFieldTitle: "Titel",
  onboardingFieldDescription: "Beskrivning",
  onboardingFieldType: "Typ",
  onboardingFieldUrl: "URL / länk",
  onboardingFieldTarget: "Målgrupp",
  onboardingSave: "Spara",
  onboardingCancel: "Avbryt",
  onboardingOpenContent: "Öppna innehåll",
} as const;
