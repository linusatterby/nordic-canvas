...
const ALLOWED_FILES = new Set([
  ...
  // API layer: DB table/column names like talent_user_id, talent_badges, etc.
  ...
  "src/lib/api/demo.ts",
  // Hooks that reference DB/API types with "talent" in names
  ...
  // Route config: route paths like /talent/*, variable names like TalentDashboard
  ...
  // Host routes: reference talent types
  ...
  // App layout: route paths like "/talent/..."
